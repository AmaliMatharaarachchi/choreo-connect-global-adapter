...
public class CcInstance extends ChoreoConnectImpl {
    ...
    private CcInstance(String dockerComposeFile, String confFileName, String backendServiceFile,
                       String gaConfigFile, boolean withCustomJwtTransformer, boolean withAnalyticsMetricImpl)
        ...
        if (!StringUtils.isEmpty(gaConfigFile)) {
            Utils.copyFile(targetDir + TestConstant.TEST_RESOURCES_PATH + TestConstant.CONFIGS_DIR
                    + File.separator + gaConfigFile, ccTempPath + TestConstant.DOCKER_COMPOSE_CC_DIR
                    + TestConstant.GA_CONFIG_TOML_PATH);
        }
    ...
    public static class Builder {
        ...
        public Builder withNewGAConfig(String gaConfigFile) {
            this.gaConfigFile = gaConfigFile;
            return this;
        }
        ...
        public CcInstance build() throws IOException, CCTestException {
            instance = new CcInstance(this.dockerComposeFile, this.confFileName, this.backendServiceFile,
                                this.gaConfigFile, this.withCustomJwtTransformer, this.withAnalyticsMetricImpl);
            return instance;
        }
    }
}
